...
var titleV, first_nameV, emailV, numberV, montantV;

function insert() {
    titleV = document.getElementById('title').value;
    first_nameV = document.getElementById('first_name').value;
    last_nameV = document.getElementById('last_namel').value;
    positionV = document.getElementById('number').value;
    optionV = document.getElementById('montant').value;
